...
Plugin page: [http://artifacts.griffon-framework.org/plugin/hazelcast](http://artifacts.griffon-framework.org/plugin/hazelcast)
...
number 5.
 ...
 6. Edit the launch script for Eclipse and tweak the boothclasspath entry so
    that includes the file you just copied
        ...
        -Xbootclasspath/a:lombok.jar:lombok-pg-<version>.jar:        griffon-lombok-compile-<version>.jar:griffon-hazelcast-compile-<version>.jar
